    ...
    <div>
      ...
      <div className= "max-w-xl mx-auto my-10">
        <form onSubmit={submitHandler}>
          <div className = "flex items-center gap-5 p-8 mb-10">
            <Button onClick= {()=> navigate("/admin/companies")} variant="outline" className="flex items-center text-gray-500 gap-2 font-semibold">
              <ArrowLeft></ArrowLeft>
              <span>Back</span>
            </Button>
